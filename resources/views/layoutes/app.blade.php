       ...
       <div class="flex flex-col  md:flex-row items-center">
           <div class="relative mt-3 md:mt-0">
               ...
               <div class="absolute top-0">
                <svg  class="fill-current w-4 text-gray-500 mt-2 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M30.414 27.586l-7.644-7.644a12.038 12.038 0 10-2.828 2.828l7.644 7.644a2 2 0 002.828-2.828zM3 13a10 10 0 1110 10A10.011 10.011 0 013 13z" /></svg>           
             </div>          
            </div>
